...
class TransactionListView(View):
    def get(self,request,*args,**kwargs):
        ...
        data=Transaction.objects.filter(
             created_date__month=c_month,
             created_date__year=c_year,
...
class TransactionCreateView(View):
        ...
        def post(self,request,*args,**kwargs):
             ...
             if form.is_valid():
                  ...
                  messages.success(request,"transaction has been addedd successfully")
...
class TransactionUpdateView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            form.save()
            messages.success(request,"Transaction has been updated sucessfully")
            return redirect("transaction-list")
        else:
            messages.error(request,"Failed to update the transaction")
            return render(request,"transaction_edit.html",{"form":form})
